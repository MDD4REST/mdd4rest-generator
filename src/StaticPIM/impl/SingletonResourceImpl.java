 ...
 * </p>
 * <ul>
 *   <li>{@link StaticPIM.impl.SingletonResourceImpl#getLookupField <em>Lookup Field</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingletonResourceImpl extends ResourceImpl implements SingletonResource {
	...
	protected EClass eStaticClass() {
		return StaticPIMPackage.Literals.SINGLETON_RESOURCE;
	}
	...
	public void setLookupField(String newLookupField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.SINGLETON_RESOURCE__LOOKUP_FIELD, oldLookupField, lookupField));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StaticPIMPackage.SINGLETON_RESOURCE__LOOKUP_FIELD:
