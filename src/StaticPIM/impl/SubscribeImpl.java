 ...
 * </p>
 * <ul>
 *   <li>{@link StaticPIM.impl.SubscribeImpl#getEventBus <em>Event Bus</em>}</li>
 *   <li>{@link StaticPIM.impl.SubscribeImpl#getTopic <em>Topic</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscribeImpl extends MinimalEObjectImpl.Container implements Subscribe {
	...
	protected EClass eStaticClass() {
		return StaticPIMPackage.Literals.SUBSCRIBE;
	}
	...
	public void setEventBus(String newEventBus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.SUBSCRIBE__EVENT_BUS, oldEventBus, eventBus));
	}
	...
	public void setTopic(String newTopic) {
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.SUBSCRIBE__TOPIC, oldTopic, topic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StaticPIMPackage.SUBSCRIBE__EVENT_BUS:
				return getEventBus();
			case StaticPIMPackage.SUBSCRIBE__TOPIC:
				return getTopic();
		}
