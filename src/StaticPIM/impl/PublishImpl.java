 ...
 * </p>
 * <ul>
 *   <li>{@link StaticPIM.impl.PublishImpl#getEventBus <em>Event Bus</em>}</li>
 *   <li>{@link StaticPIM.impl.PublishImpl#getTopic <em>Topic</em>}</li>
 *   <li>{@link StaticPIM.impl.PublishImpl#getEventType <em>Event Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PublishImpl extends MinimalEObjectImpl.Container implements Publish {
	...
	protected EClass eStaticClass() {
		return StaticPIMPackage.Literals.PUBLISH;
	}
	...
	public void setEventBus(String newEventBus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.PUBLISH__EVENT_BUS, oldEventBus, eventBus));
	}
	...
	public void setTopic(String newTopic) {
		...
		topic = newTopic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.PUBLISH__TOPIC, oldTopic, topic));
	}
	...
	public Event getEventType() {
		if (eventType != null && eventType.eIsProxy()) {
			...
			if (eventType != oldEventType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StaticPIMPackage.PUBLISH__EVENT_TYPE, oldEventType, eventType));
			}
		}
		return eventType;
	}
	...
	public void setEventType(Event newEventType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.PUBLISH__EVENT_TYPE, oldEventType, eventType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StaticPIMPackage.PUBLISH__EVENT_BUS:
				return getEventBus();
			case StaticPIMPackage.PUBLISH__TOPIC:
				return getTopic();
			case StaticPIMPackage.PUBLISH__EVENT_TYPE:
