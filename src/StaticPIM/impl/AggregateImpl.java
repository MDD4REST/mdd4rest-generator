 ...
 * </p>
 * <ul>
 *   <li>{@link StaticPIM.impl.AggregateImpl#getDomainobjects <em>Domainobjects</em>}</li>
 *   <li>{@link StaticPIM.impl.AggregateImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AggregateImpl extends MinimalEObjectImpl.Container implements Aggregate {
	...
	protected EClass eStaticClass() {
		return StaticPIMPackage.Literals.AGGREGATE;
	}
	...
	public EList<DomainObject> getDomainobjects() {
		if (domainobjects == null) {
			domainobjects = new EObjectContainmentEList<DomainObject>(DomainObject.class, this, StaticPIMPackage.AGGREGATE__DOMAINOBJECTS);
		}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.AGGREGATE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StaticPIMPackage.AGGREGATE__DOMAINOBJECTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case StaticPIMPackage.AGGREGATE__NAME:
				return getName();
		}
