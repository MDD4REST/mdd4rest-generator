 ...
 * </p>
 * <ul>
 *   <li>{@link StaticPIM.impl.ProjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link StaticPIM.impl.ProjectImpl#getBasePath <em>Base Path</em>}</li>
 *   <li>{@link StaticPIM.impl.ProjectImpl#getHasApplication <em>Has Application</em>}</li>
 *   <li>{@link StaticPIM.impl.ProjectImpl#getPrimitiveTypes <em>Primitive Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProjectImpl extends EObjectImpl implements Project {
	...
	protected EClass eStaticClass() {
		return StaticPIMPackage.Literals.PROJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.PROJECT__NAME, oldName, name));
	}
	...
	public void setBasePath(String newBasePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaticPIMPackage.PROJECT__BASE_PATH, oldBasePath, basePath));
	}
	...
	public EList<Application> getHasApplication() {
		if (hasApplication == null) {
			hasApplication = new EObjectContainmentWithInverseEList<Application>(Application.class, this, StaticPIMPackage.PROJECT__HAS_APPLICATION, StaticPIMPackage.APPLICATION__PROJECT);
		}
	...
	public EList<PrimitiveType> getPrimitiveTypes() {
		if (primitiveTypes == null) {
			primitiveTypes = new EObjectContainmentEList<PrimitiveType>(PrimitiveType.class, this, StaticPIMPackage.PROJECT__PRIMITIVE_TYPES);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StaticPIMPackage.PROJECT__HAS_APPLICATION:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StaticPIMPackage.PROJECT__PRIMITIVE_TYPES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StaticPIMPackage.PROJECT__NAME:
				return getName();
			case StaticPIMPackage.PROJECT__BASE_PATH:
				return getBasePath();
			case StaticPIMPackage.PROJECT__HAS_APPLICATION:
