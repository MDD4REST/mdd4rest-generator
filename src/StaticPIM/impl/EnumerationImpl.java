 ...
 * </p>
 * <ul>
 *   <li>{@link StaticPIM.impl.EnumerationImpl#getLiterals <em>Literals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumerationImpl extends DomainObjectImpl implements Enumeration {
	...
	protected EClass eStaticClass() {
		return StaticPIMPackage.Literals.ENUMERATION;
	}
	...
	public EList<Literal> getLiterals() {
		if (literals == null) {
			literals = new EObjectContainmentEList<Literal>(Literal.class, this, StaticPIMPackage.ENUMERATION__LITERALS);
		}
		return literals;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StaticPIMPackage.ENUMERATION__LITERALS:
