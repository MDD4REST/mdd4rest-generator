 ...
 * </p>
 * <ul>
 *   <li>{@link DynamicPIM.impl.ComplexTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexTypeImpl extends TypeDefinitionImpl implements ComplexType {
	...
	protected EClass eStaticClass() {
		return DynamicPIMPackage.Literals.COMPLEX_TYPE;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DynamicPIMPackage.COMPLEX_TYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TypeDefinition newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DynamicPIMPackage.COMPLEX_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DynamicPIMPackage.COMPLEX_TYPE__TYPE:
