 ...
 * </p>
 * <ul>
 *   <li>{@link DynamicPIM.impl.PolicyImpl#getEventType <em>Event Type</em>}</li>
 *   <li>{@link DynamicPIM.impl.PolicyImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolicyImpl extends EObjectImpl implements Policy {
	...
	protected EClass eStaticClass() {
		return DynamicPIMPackage.Literals.POLICY;
	}
		...
		if (eventType != null && eventType.eIsProxy()) {
			...
			if (eventType != oldEventType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DynamicPIMPackage.POLICY__EVENT_TYPE, oldEventType, eventType));
			}
		}
		return eventType;
	}
	...
	public void setEventType(Event newEventType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DynamicPIMPackage.POLICY__EVENT_TYPE, oldEventType, eventType));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DynamicPIMPackage.POLICY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DynamicPIMPackage.POLICY__EVENT_TYPE:
				if (resolve) return getEventType();
				return basicGetEventType();
			case DynamicPIMPackage.POLICY__NAME:
				return getName();
		}
