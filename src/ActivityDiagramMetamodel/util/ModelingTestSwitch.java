 ...
 * <!-- end-user-doc -->
 * @see ActivityDiagramMetamodel.ModelingTestPackage
 * @generated
 */
public class ModelingTestSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ModelingTestPackage modelPackage;
	 ...
	 * @generated
	 */
	public ModelingTestSwitch() {
		if (modelPackage == null) {
			modelPackage = ModelingTestPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelingTestPackage.CONTROL_FLOW: {
			...
			case ModelingTestPackage.CONTROL_NODE: {
			...
			case ModelingTestPackage.EXECUTABLE_NODE: {
			...
			case ModelingTestPackage.INITIAL_NODE: {
			...
			case ModelingTestPackage.FORK_NODE: {
			...
			case ModelingTestPackage.JOIN_NODE: {
			...
			case ModelingTestPackage.DECISION_NODE: {
			...
			case ModelingTestPackage.MERGE_NODE: {
			...
			case ModelingTestPackage.FINAL_NODE: {
			...
			case ModelingTestPackage.INPUT_PIN: {
			...
			case ModelingTestPackage.OUTPUT_PIN: {
			...
			case ModelingTestPackage.OBJECT_NODE: {
			...
			case ModelingTestPackage.ACTIVITY_PARAMETER_NODE: {
			...
			case ModelingTestPackage.CALL_ACTION: {
			...
			case ModelingTestPackage.VARIABLE_ACTION: {
			...
			case ModelingTestPackage.START_OBJECT_BEHAVIOR_ACTION: {
			...
			case ModelingTestPackage.OBJECT_ACTION: {
			...
			case ModelingTestPackage.CALL_BEHAVIOR_ACTION: {
			...
			case ModelingTestPackage.CALL_OPERATION_ACTION: {
			...
			case ModelingTestPackage.CALL_ACTIVITY_ACTION: {
			...
			case ModelingTestPackage.COMMAND_ACTION: {
