 ...
 * </p>
 * <ul>
 *   <li>{@link ActivityDiagramMetamodel.impl.CallActivityActionImpl#getActivitydiagram <em>Activitydiagram</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CallActivityActionImpl extends CallActionImpl implements CallActivityAction {
	...
	protected EClass eStaticClass() {
		return ActivityDiagramMetamodelPackage.Literals.CALL_ACTIVITY_ACTION;
	}
	...
	public NotificationChain basicSetActivitydiagram(ActivityDiagram newActivitydiagram, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActivityDiagramMetamodelPackage.CALL_ACTIVITY_ACTION__ACTIVITYDIAGRAM, oldActivitydiagram, newActivitydiagram);
	...
	public void setActivitydiagram(ActivityDiagram newActivitydiagram) {
		if (newActivitydiagram != activitydiagram) {
			...
			if (activitydiagram != null)
				msgs = ((InternalEObject)activitydiagram).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ActivityDiagramMetamodelPackage.CALL_ACTIVITY_ACTION__ACTIVITYDIAGRAM, null, msgs);
			if (newActivitydiagram != null)
				msgs = ((InternalEObject)newActivitydiagram).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ActivityDiagramMetamodelPackage.CALL_ACTIVITY_ACTION__ACTIVITYDIAGRAM, null, msgs);
			msgs = basicSetActivitydiagram(newActivitydiagram, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityDiagramMetamodelPackage.CALL_ACTIVITY_ACTION__ACTIVITYDIAGRAM, newActivitydiagram, newActivitydiagram));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityDiagramMetamodelPackage.CALL_ACTIVITY_ACTION__ACTIVITYDIAGRAM:
