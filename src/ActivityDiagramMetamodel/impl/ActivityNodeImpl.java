 ...
 * </p>
 * <ul>
 *   <li>{@link ActivityDiagramMetamodel.impl.ActivityNodeImpl#getIncomming <em>Incomming</em>}</li>
 *   <li>{@link ActivityDiagramMetamodel.impl.ActivityNodeImpl#getOutcomming <em>Outcomming</em>}</li>
 *   <li>{@link ActivityDiagramMetamodel.impl.ActivityNodeImpl#getActivitypartition <em>Activitypartition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityNodeImpl extends EObjectImpl implements ActivityNode {
	...
	protected EClass eStaticClass() {
		return ActivityDiagramMetamodelPackage.Literals.ACTIVITY_NODE;
	}
	...
	public EList<ActivityEdge> getIncomming() {
		if (incomming == null) {
			incomming = new EObjectWithInverseResolvingEList<ActivityEdge>(ActivityEdge.class, this, ActivityDiagramMetamodelPackage.ACTIVITY_NODE__INCOMMING, ActivityDiagramMetamodelPackage.ACTIVITY_EDGE__TARGET);
		}
		return incomming;
	}
	...
	public EList<ActivityEdge> getOutcomming() {
		if (outcomming == null) {
			outcomming = new EObjectWithInverseResolvingEList<ActivityEdge>(ActivityEdge.class, this, ActivityDiagramMetamodelPackage.ACTIVITY_NODE__OUTCOMMING, ActivityDiagramMetamodelPackage.ACTIVITY_EDGE__SOURCE);
		}
		return outcomming;
	}
	...
	public ActivityPartition getActivitypartition() {
		if (eContainerFeatureID() != ActivityDiagramMetamodelPackage.ACTIVITY_NODE__ACTIVITYPARTITION) return null;
	...
	public NotificationChain basicSetActivitypartition(ActivityPartition newActivitypartition, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newActivitypartition, ActivityDiagramMetamodelPackage.ACTIVITY_NODE__ACTIVITYPARTITION, msgs);
		return msgs;
	}
	...
	public void setActivitypartition(ActivityPartition newActivitypartition) {
		if (newActivitypartition != eInternalContainer() || (eContainerFeatureID() != ActivityDiagramMetamodelPackage.ACTIVITY_NODE__ACTIVITYPARTITION && newActivitypartition != null)) {
			...
			if (newActivitypartition != null)
				msgs = ((InternalEObject)newActivitypartition).eInverseAdd(this, ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__ACTIVITYNODE, ActivityPartition.class, msgs);
			msgs = basicSetActivitypartition(newActivitypartition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityDiagramMetamodelPackage.ACTIVITY_NODE__ACTIVITYPARTITION, newActivitypartition, newActivitypartition));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityDiagramMetamodelPackage.ACTIVITY_NODE__INCOMMING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getIncomming()).basicAdd(otherEnd, msgs);
			case ActivityDiagramMetamodelPackage.ACTIVITY_NODE__OUTCOMMING:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getOutcomming()).basicAdd(otherEnd, msgs);
			case ActivityDiagramMetamodelPackage.ACTIVITY_NODE__ACTIVITYPARTITION:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ActivityDiagramMetamodelPackage.ACTIVITY_NODE__ACTIVITYPARTITION:
				return eInternalContainer().eInverseRemove(this, ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__ACTIVITYNODE, ActivityPartition.class, msgs);
		}
