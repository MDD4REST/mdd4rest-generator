 ...
 * </p>
 * <ul>
 *   <li>{@link ActivityDiagramMetamodel.impl.EventActionImpl#getAggregate <em>Aggregate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventActionImpl extends ActionImpl implements EventAction {
	/**
	...
	protected EClass eStaticClass() {
		return ActivityDiagramMetamodelPackage.Literals.EVENT_ACTION;
	}
		...
		if (aggregate != null && aggregate.eIsProxy()) {
			...
			if (aggregate != oldAggregate) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ActivityDiagramMetamodelPackage.EVENT_ACTION__AGGREGATE, oldAggregate, aggregate));
			}
		}
		return aggregate;
	}
	...
	public NotificationChain basicSetAggregate(Aggregate newAggregate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ActivityDiagramMetamodelPackage.EVENT_ACTION__AGGREGATE, oldAggregate, newAggregate);
	...
	public void setAggregate(Aggregate newAggregate) {
		if (newAggregate != aggregate) {
			...
			if (aggregate != null)
				msgs = ((InternalEObject)aggregate).eInverseRemove(this, ActivityDiagramMetamodelPackage.AGGREGATE__EVENTS, Aggregate.class, msgs);
			if (newAggregate != null)
				msgs = ((InternalEObject)newAggregate).eInverseAdd(this, ActivityDiagramMetamodelPackage.AGGREGATE__EVENTS, Aggregate.class, msgs);
			msgs = basicSetAggregate(newAggregate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityDiagramMetamodelPackage.EVENT_ACTION__AGGREGATE, newAggregate, newAggregate));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityDiagramMetamodelPackage.EVENT_ACTION__AGGREGATE:
				if (aggregate != null)
					msgs = ((InternalEObject)aggregate).eInverseRemove(this, ActivityDiagramMetamodelPackage.AGGREGATE__EVENTS, Aggregate.class, msgs);
