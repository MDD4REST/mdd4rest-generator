 ...
 * </p>
 * <ul>
 *   <li>{@link ActivityDiagramMetamodel.impl.DecisionNodeImpl#getObjectnode <em>Objectnode</em>}</li>
 *   <li>{@link ActivityDiagramMetamodel.impl.DecisionNodeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DecisionNodeImpl extends ControlNodeImpl implements DecisionNode {
	...
	protected EClass eStaticClass() {
		return ActivityDiagramMetamodelPackage.Literals.DECISION_NODE;
	}
	...
	public EList<ObjectNode> getObjectnode() {
		if (objectnode == null) {
			objectnode = new EObjectResolvingEList<ObjectNode>(ObjectNode.class, this, ActivityDiagramMetamodelPackage.DECISION_NODE__OBJECTNODE);
		}
		return objectnode;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityDiagramMetamodelPackage.DECISION_NODE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityDiagramMetamodelPackage.DECISION_NODE__OBJECTNODE:
				return getObjectnode();
			case ActivityDiagramMetamodelPackage.DECISION_NODE__NAME:
				return getName();
		}
