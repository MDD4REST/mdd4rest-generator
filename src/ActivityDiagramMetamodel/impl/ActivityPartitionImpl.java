 ...
 * </p>
 * <ul>
 *   <li>{@link ActivityDiagramMetamodel.impl.ActivityPartitionImpl#getName <em>Name</em>}</li>
 *   <li>{@link ActivityDiagramMetamodel.impl.ActivityPartitionImpl#getSubpartition <em>Subpartition</em>}</li>
 *   <li>{@link ActivityDiagramMetamodel.impl.ActivityPartitionImpl#getActivityedge <em>Activityedge</em>}</li>
 *   <li>{@link ActivityDiagramMetamodel.impl.ActivityPartitionImpl#getActivitynode <em>Activitynode</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActivityPartitionImpl extends EObjectImpl implements ActivityPartition {
	...
	protected EClass eStaticClass() {
		return ActivityDiagramMetamodelPackage.Literals.ACTIVITY_PARTITION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__NAME, oldName, name));
	}
	...
	public EList<ActivityPartition> getSubpartition() {
		if (subpartition == null) {
			subpartition = new EObjectContainmentEList<ActivityPartition>(ActivityPartition.class, this, ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__SUBPARTITION);
		}
		return subpartition;
	}
	...
	public EList<ActivityEdge> getActivityedge() {
		if (activityedge == null) {
			activityedge = new EObjectContainmentWithInverseEList<ActivityEdge>(ActivityEdge.class, this, ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__ACTIVITYEDGE, ActivityDiagramMetamodelPackage.ACTIVITY_EDGE__ACTIVITYPARTITION);
		}
		return activityedge;
	}
	...
	public EList<ActivityNode> getActivitynode() {
		if (activitynode == null) {
			activitynode = new EObjectContainmentWithInverseEList<ActivityNode>(ActivityNode.class, this, ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__ACTIVITYNODE, ActivityDiagramMetamodelPackage.ACTIVITY_NODE__ACTIVITYPARTITION);
		}
		return activitynode;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__ACTIVITYEDGE:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getActivityedge()).basicAdd(otherEnd, msgs);
			case ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__ACTIVITYNODE:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__SUBPARTITION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__NAME:
				return getName();
			case ActivityDiagramMetamodelPackage.ACTIVITY_PARTITION__SUBPARTITION:
