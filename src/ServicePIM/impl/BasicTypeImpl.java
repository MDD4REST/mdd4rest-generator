 ...
 * </p>
 * <ul>
 *   <li>{@link ServicePIM.impl.BasicTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BasicTypeImpl extends TypeDefinitionImpl implements BasicType {
	/**
	...
	protected EClass eStaticClass() {
		return ServicePIMPackage.Literals.BASIC_TYPE;
	}
	...
	public void setType(PropertyType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePIMPackage.BASIC_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePIMPackage.BASIC_TYPE__TYPE:
				return getType();
		}
