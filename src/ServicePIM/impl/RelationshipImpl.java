 ...
 * </p>
 * <ul>
 *   <li>{@link ServicePIM.impl.RelationshipImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link ServicePIM.impl.RelationshipImpl#getFromResource <em>From Resource</em>}</li>
 *   <li>{@link ServicePIM.impl.RelationshipImpl#getToResource <em>To Resource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationshipImpl extends MinimalEObjectImpl.Container implements Relationship {
	...
	protected EClass eStaticClass() {
		return ServicePIMPackage.Literals.RELATIONSHIP;
	}
	...
	public void setMultiplicity(Multiplicity newMultiplicity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePIMPackage.RELATIONSHIP__MULTIPLICITY, oldMultiplicity, multiplicity));
	}
	...
	public Resource getFromResource() {
		if (fromResource != null && fromResource.eIsProxy()) {
			...
			if (fromResource != oldFromResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePIMPackage.RELATIONSHIP__FROM_RESOURCE, oldFromResource, fromResource));
			}
		}
		return fromResource;
	}
	...
	public void setFromResource(Resource newFromResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePIMPackage.RELATIONSHIP__FROM_RESOURCE, oldFromResource, fromResource));
	}
	...
	public Resource getToResource() {
		if (toResource != null && toResource.eIsProxy()) {
			...
			if (toResource != oldToResource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ServicePIMPackage.RELATIONSHIP__TO_RESOURCE, oldToResource, toResource));
			}
		}
		return toResource;
	}
	...
	public void setToResource(Resource newToResource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePIMPackage.RELATIONSHIP__TO_RESOURCE, oldToResource, toResource));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePIMPackage.RELATIONSHIP__MULTIPLICITY:
				return getMultiplicity();
			case ServicePIMPackage.RELATIONSHIP__FROM_RESOURCE:
				if (resolve) return getFromResource();
				return basicGetFromResource();
			case ServicePIMPackage.RELATIONSHIP__TO_RESOURCE:
