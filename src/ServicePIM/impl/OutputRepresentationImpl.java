 ...
 * </p>
 * <ul>
 *   <li>{@link ServicePIM.impl.OutputRepresentationImpl#getOutputMediaType <em>Output Media Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputRepresentationImpl extends MinimalEObjectImpl.Container implements OutputRepresentation {
	...
	protected EClass eStaticClass() {
		return ServicePIMPackage.Literals.OUTPUT_REPRESENTATION;
	}
	...
	public void setOutputMediaType(MediaType newOutputMediaType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ServicePIMPackage.OUTPUT_REPRESENTATION__OUTPUT_MEDIA_TYPE, oldOutputMediaType, outputMediaType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ServicePIMPackage.OUTPUT_REPRESENTATION__OUTPUT_MEDIA_TYPE:
