 ...
 * </p>
 * <ul>
 *   <li>{@link SecurityPIM.impl.LogicalOperatorImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalOperatorImpl extends MinimalEObjectImpl.Container implements LogicalOperator {
	...
	protected EClass eStaticClass() {
		return SecurityPIMMetamodelPackage.Literals.LOGICAL_OPERATOR;
	}
	...
	public void setOperator(LogicalOperatorType newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPIMMetamodelPackage.LOGICAL_OPERATOR__OPERATOR, oldOperator, operator));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SecurityPIMMetamodelPackage.LOGICAL_OPERATOR__OPERATOR:
				return getOperator();
		}
