...
/**
 * Generated base class for implementation of Destination.
...
public abstract class DestinationBase {
	...
	/**
	 * This method is needed for form data POST. Delegates to {@link #changeDestination}
	 */
	@RequestMapping(value = "/cargoes/{trackingID}/destination", method = RequestMethod.POST, headers = "content-type=application/x-www-form-urlencoded")
	public void changeDestinationFromForm() {
		changeDestination();
	}
